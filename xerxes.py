...
#echo -e "	[+]              $red recoded By Rady_Monim$nc         		   [+]"
#echo -e "	[+] 		 $red xerxes888251.blogspot.com $nc 		   [+]"
#echo -e "	[+] 		 $red Greetings To All Pentesters$nc          		   [+]"
#echo -e "	[+]$red Special Greetz To$nc :$green {thelinuxchoice , xerxes888, Papuan Recoder, rady_monim}$nc [+]"
echo ""
